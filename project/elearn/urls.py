...
path('show_lesson/<int:pk>/', login_required(views.ShowLessonView.as_view()), name='show_lesson'),
path('update_lesson/<int:pk>/',login_required(views.UpdateLessonView.as_view()), name='update_lesson'),
path('test_list', login_required(views.TestListView.as_view()), name='test_list'),
path('update_test/<int:pk>/', login_required(views.UpdateTestView.as_view()), name='update_test'),
path('show_test/<int:pk>/', login_required(views.ShowTestView.as_view()), name='show_test'),
path('solve_test/<int:pk>/', login_required(views.SolveTestView.as_view()), name='solve_test'),
