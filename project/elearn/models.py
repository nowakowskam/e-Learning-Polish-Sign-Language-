...
class Lesson(models.Model):
    ...
    miniature = models.ImageField(
        upload_to="", default="lekcja.png", verbose_name="Miniatura"
    )
    description = models.TextField(
        verbose_name="Opis", editable=True, default="", blank=True
    )
...
class Test(models.Model):
    ...
    image = models.ImageField(
        upload_to="tests", blank=True, verbose_name="Zdjęcie", default=""
    )
    ...
    answer = models.CharField(
        max_length=200, null=True, verbose_name="Poprawna odpowiedź"
    )
...
class Comment(models.Model):
    owner = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, verbose_name="użytkownik"
    )
